      ...
      fluidRow(
        column(2,
          ...
          div(
            ...
            radioButtons("radioTab2",
              label = h5("Transportation Services"),
              choices = list(
                "Taxi Trends" = "taxi", "For Hire Vehicle Trends" = "FHV",
                "Both" = "both"
              ), selected = "both"
            )
          )
        ...
        column(
          ...
          div(
            style = "font-size: 10px",
            radioButtons("trendTab2",
              label = h5("Trend Line"),
              choices = list(
                "Show Trend Line" = "show",
                "Don't Show Line" = "dont_show"
              ), selected = "show"
            )
          )
        ),
        column(
          ...
          div(
            style = "font-size: 10px",
            radioButtons("dailyTab2",
              label = h5("View data in:"),
    ...
    tabPanel(
      ...
      fluidRow(
        ...
        column(3,
          offset = 3,
          div(
            style = "font-size: 10px; padding: 0px 0px; margin:0%",
            radioButtons("radioTab3",
              label = h5("Transportation Services"),
              choices = list(
                "Taxi Trends" = "Yellow", "For Hire Vehicle Trends" = "FHV",
                "Both" = "both"
              ), selected = "both"
            )
          )
